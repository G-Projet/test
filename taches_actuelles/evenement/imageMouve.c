...
int main(int argc,char** argv)
{
	...
	screen = SDL_GetVideoDriver(
				LARGEUR_TILE*NOMBRE_BLOCS_LARGEUR, 
				HAUTEUR_TILE*NOMBRE_BLOCS_HAUTEUR, 32,
				SDL_WINDOW_SHOWN|SDL_WINDOW_RESIZABLE);//SDL_HWSURFACE|SDL_DOUBLEBUF);

	tileset = IMG_Load("duck.png");
	if (!tileset)
	{
